...
[🎥 INSERTA AQUÍ EL REPRODUCTOR DE TU VIDEO DE YOUTUBE]
(Nota: Aquí los lectores verán tu video animado de pizarra o los clips del dron esquivando la columna justo antes de empezar a leer).
...
[🎧 ¿PREFIERES ESCUCHAR ESTA HISTORIA? DALE PLAY A NUESTRO PODCAST AQUÍ]
(Nota: Aquí puedes incrustar el widget de audio de tu podcast de NotebookLM o el link de YouTube de tu playlist de audio).
...
[📊 INSERTA AQUÍ TU INFOGRAFÍA RESUMEN]
(Nota: Insertar aquí la infografía le dará un descanso visual al lector y fomentará que la compartan en sus redes sociales).
