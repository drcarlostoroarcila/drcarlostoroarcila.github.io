...
<ul>
  {% for post in site.posts %}
    <li>
      <strong>{{ post.date | date: "%d/%m/%Y" }}</strong> - <a href="{{ post.url }}">{{ post.title }}</a>
    </li>
  {% endfor %}
</ul>
...
* **[07/08/2026] El Diario de Coahuila:** *"Drones aliados: volar para cuidarnos"*. 
  👉 [Leer artículo en línea](https://eldiariodecoahuila.com.mx/2026/08/07/drones-aliados-volar-para-cuidarnos/)

* **[31/07/2026] El Diario de Coahuila:** *"Divulgación UAdeC – Tecnología al vuelo: la ciencia detrás de los drones. Coreografías en el cielo: cuando las máquinas hacen equipo"*. 
  👉 [Leer artículo en línea](https://eldiariodecoahuila.com.mx/2026/07/31/divulgacion-uadec-tecnologia-al-vuelo-la-ciencia-detras-de-los-drones-coreografias-en-el-cielo-cuando-las-maquinas-hacen-equipo/)

* **[24/07/2026] El Diario de Coahuila:** *"Divulgación UAdeC – Tecnología al vuelo: la ciencia detrás de los drones. Reflejos robóticos: cuando la visión se convierte en movimiento"*. 
  👉 [Leer artículo en línea](https://eldiariodecoahuila.com.mx/2026/07/24/divulgacion-uadec-tecnologia-al-vuelo-la-ciencia-detras-de-los-drones-reflejos-roboticos-cuando-la-vision-se-convierte-en-movimiento/)
